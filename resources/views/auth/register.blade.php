@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('AL SALAM BANK')])
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="{{ __('Confirmer Mot de passe...') }}" required>
              </div>
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('Je suis d"accord avec ') }} <a href="#">{{ __('la Politique de Confidentialité') }}</a>
              </label>
            </div>
          </div>
